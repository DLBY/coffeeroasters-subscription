    ...
    <section className="container mx-auto px-6">
      <div className={className + " " + "rounded-[10px]"}>
        <div className={clsx(
          ...
          "xl:w-[50%] lg:px-[85px] lg:py-[117px]",
        )}>
          <h1 className={clsx(
            "text-lightCream font-serif font-bold text-[40px] leading-10",
            "md:text-5xl lg:text-7xl",
          )}>{title}</h1>
          <p className="mt-8 text-lightCream text-[15px] leading-[25px] lg:text-base">{subtitle}</p>
          <Button link="/plan" text={cta.text} className="text-lightCream bg-darkCyan hover:bg-cyan px-8 py-4 mt-10 rounded-md transition-colors font-serif text-lg leading-[25px]" />
        </div>
      </div>
    </section>
  );
